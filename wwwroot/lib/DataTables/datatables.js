 ...
 *   https://datatables.net/download/#bs5/dt-2.3.8/cr-2.1.2/date-1.6.3/r-3.0.8/sc-2.4.3
 *
 * Included libraries:
 *   DataTables 2.3.8, ColReorder 2.1.2, DateTime 1.6.3, Responsive 3.0.8, Scroller 2.4.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.3.8/cr-2.1.2/date-1.6.3/r-3.0.8/sc-2.4.3",
